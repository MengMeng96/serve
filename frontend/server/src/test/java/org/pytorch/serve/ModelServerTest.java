...
public class ModelServerTest {
    ...
    public void testRootInference() throws InterruptedException {
        ...
        TestUtils.getLatch().await();
        System.out.println(TestUtils.getResult().replaceAll("r\"", "\r\""));
        System.out.println("---------------------");
        System.out.println(listInferenceApisResult.replaceAll("r\"", "\r\""));
        Assert.assertEquals(TestUtils.getResult().replaceAll("r\"", "\r\"")
                , listInferenceApisResult);
    }
